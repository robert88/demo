...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#21d015">
  ...
  <tr>
    <td height="24" align="center" nowrap  bgcolor="#EBF2F9"><a href="task_tadd.asp?Result=Add" onClick='changeAdminFlag("添加管理员")'>添加课题</a><font color="#0000FF">&nbsp;|&nbsp;</font><a href="task_list.asp" onClick='changeAdminFlag("系统管理员")'>查看所有课题</a><font color="#0000FF">&nbsp;|</font></td>    
  </tr>
</table>
  <center>
    <br/>
  ...
  <tr>
    <td height="24" nowrap bgcolor="#EBF2F9"><table width="100%" border="0" cellpadding="0" cellspacing="0" id=editProduct idth="100%">
      ...
      <tr>
		...
		%>
            <%do while not rs.eof%>
            <option value="<%=rs("Tea_id")%>"
			<% if rs("Tea_id")=session("user_no") then response.Write("selected='selected'") end if%>
			><%=rs("Tea_name")%></option>
            <%
				rs.movenext
				loop
