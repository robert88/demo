...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#21d015">
  ...
  <tr>
	...
	<form id="form1" name="form1" method="post" action="task_yes.asp">
        方向：
...
<br />
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#21d015">
    <tr>
      ...
      <td nowrap bgcolor="#21d015"><font color="#FFFFFF"><strong>限选专业</strong></font></td>
  ...
  <%
		...
		sql = "select * from student_info stu,select_cursor sel,teacher_inf tea ,speciality sp where stu.St_number=sel.St_number and tea.Tea_id=sel.Tea_id and stu.Sp_id=sp.Sp_id"&wh&" order by stu.St_number asc"
		'response.Write(sql)
