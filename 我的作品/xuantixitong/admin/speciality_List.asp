...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#21d015">
  ...
  <tr>
    <td height="24" align="center" nowrap  bgcolor="#EBF2F9"><a href="speciality_add.asp?Result=Add" onClick='changeAdminFlag("添加专业")'>添加专业</a><font color="#0000FF">&nbsp;|&nbsp;</font><a href="speciality_list.asp" onClick='changeAdminFlag("专业列表")'>查看所有专业</a></td>    
  </tr>
</table>
<br />
  <center>
...
'		rsobj.open "select * from speciality",conn ,1,1
  ...
  <tr bgcolor="#FFFFFF" onmouseover="this.bgColor='f1f1f1'" onmouseout="this.bgColor='FFFFFF'">
    ...
    <td><%=rsobj("Sp_name")%></td>
    <td><%=rsobj("D_name")%></td>
    <td><a href='speciality_add.asp?Result=Modify&ID=<%=rsobj("speciality.ID")%>' onClick='changeAdminFlag("修改系别")'><font color='#330099'>修改</font></a></td>
...
　
  <%
			if page <> 1 then
			response.Write"<a href=speciality_list.asp?txtpage=1>　第一页　</a>"
			response.Write"<a href=speciality_list.asp?txtpage="& (page-1)&">　上一页　</a>"
			end if 
			if page<>rsobj.pagecount then
			response.Write"<a href=speciality_list.asp?txtpage="& (page+1)&">　下一页　</a>"
			response.Write"<a href=speciality_list.asp?txtpage="& rsobj.pagecount&">　最末页　</a>"
			end if
			'关闭链接
			rsobj.close
			set rsobj=nothing
